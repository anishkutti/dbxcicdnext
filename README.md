...
==========
Please note
Disclaimer: This is sample  code intented for proof of concept. 
			Not to use for Production

===========
The 'dbxcicdnext' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbxcicdnext_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dbxcicdnext.job.yml). The schedule
